...
//                     }}
//                   />
//                   <span className="text-[#484848] font-bold text-[14px] xl:text-[16px] lg:text-[16px] md:text-[16px]">
//                     (+91) 89398 00027
//                     <br className="xl:hidden lg:hidden md:hidden" /> (10 am - 07
//                     pm, IST)
//                   </span>
//                 </p>
//               </div>
...
//                 </p>
//               </div>
//               {/* <div className="flext justify-center border-gray-300 border rounded-full xl:w-[450px] px-5 xl:py-2 py-3 mt-6 bg-[#F7F7F7]">
//                 <p className="flex justify-start items-center gap-5">
//                   <Image
